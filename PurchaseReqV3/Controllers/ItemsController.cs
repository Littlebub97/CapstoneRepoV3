...
namespace PurchaseReqV3.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Quantity,UnitPrice,Description,ActualPrice,PurchaseRequisitionId")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Quantity,UnitPrice,Description,ActualPrice,PurchaseRequisitionId")] Item item)
        {
            if (ModelState.IsValid)
            {
